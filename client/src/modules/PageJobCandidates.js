...
class PageJobCandidates extends Component {
  ...
  refreshData = (state) => {
    ...
    let query = API.buildEmployeeQueryFromState(state)
  ...
  handleRowClick = (event, _id) => {
    ...
    this.props.history.push('candidates/' + _id)
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        ...
        <Card>
          <CardHeader>
            <i className="icon-menu"></i>Job Candidates
          </CardHeader>
          <CardBody>
...
export default PageJobCandidates
